...
def test_get_html_from_url_bad_address():
    with pytest.raises(URLError):
        scraper.get_html_from_url("https://www.ouqwygwufgw.com/")


def test_get_html_from_url_invalid_url():
    with pytest.raises(ValueError):
        scraper.get_html_from_url("invalid url")
